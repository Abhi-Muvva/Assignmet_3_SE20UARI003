...
fcfs_schedule, fcfs_avg_waiting_time, fcfs_avg_turnaround_time = fcfs_scheduling(processes)
sjf_schedule, sjf_avg_waiting_time, sjf_avg_turnaround_time = sjf_scheduling(processes)
print(processes)
